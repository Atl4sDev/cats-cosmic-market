...
import edu.catscosmicmarket.featuretoggle.aspect.FeatureToggleAspect;
...
@Import(CosmoCatServiceTestIT.Config.class)  // Імпортує конфігурацію тестів
public class CosmoCatServiceTestIT {
    ...
    void getCosmoCats_ShouldReturnList_WhenFeatureIsEnabled() {
        ...
        assertTrue(result.contains("Cosmofury"));
        assertTrue(result.contains("Galactio"));
        assertTrue(result.contains("Lunapaws"));
        assertTrue(result.contains("Skyshine"));
    }
