package edu.catscosmicmarket.validation;
...
public class CosmicWordValidator implements ConstraintValidator<CosmicWordCheck, String> {
    ...
    private static final List<String> COSMIC_TERMS = Arrays.asList("star", "galaxy", "comet", "planet", "space", "asteroid", "Mars", "Pluto", "gravity");
